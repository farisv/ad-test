...
WEB = {
    'web-php': 'http://web-php:8081',
    'web-go': 'http://web-go:8082',
    'web-node': 'http://web-node:8083',
    'web-java': 'http://web-java:8084',
}
BIN = {'bin-socat': ('bin-socat', 9001), 'bin-socket': ('bin-socket', 9002)}
